...
const RiskMatrixModal: React.FC<Props> = ({ show, onClose, theme }) => {
  if (!show) return null;
        ...
        <div className="p-8 border-b border-inherit flex justify-between items-center bg-amber-50/5">
          <div className="flex items-center gap-5">
            ...
            <div>
              ...
              <p className="text-[10px] font-black text-amber-600 uppercase tracking-widest mt-1">Evaluación de Contingencias 2027</p>
            </div>
          </div>
